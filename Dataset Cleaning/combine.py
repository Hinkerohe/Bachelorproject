...
# with open( "./InOutPairs/19A20A.tsv", "w") as I:
#     InOut.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/19A20AFull.tsv", "w") as I:
#     InOut.to_csv(I,sep = '\t')

# with open( "./InOutPairs/19A19B.tsv", "w") as I:
#     InOut2.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/19A19BFull.tsv", "w") as I:
#     InOut2.to_csv(I,sep = '\t')



# with open( "./InOutPairs/20A1.tsv", "w") as I:
#     InOut3.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20A1Full.tsv", "w") as I:
#     InOut3.to_csv(I,sep = '\t')

# with open( "./InOutPairs/20A2.tsv", "w") as I:
#     InOut4.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20A2Full.tsv", "w") as I:
#     InOut4.to_csv(I,sep = '\t')

# with open( "./InOutPairs/20A3.tsv", "w") as I:
#     InOut5.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20A3Full.tsv", "w") as I:
#     InOut5.to_csv(I,sep = '\t')

# with open( "./InOutPairs/20A4.tsv", "w") as I:
#     InOut6.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20A4Full.tsv", "w") as I:
#     InOut6.to_csv(I,sep = '\t')

# with open( "./InOutPairs/20A5.tsv", "w") as I:
#     InOut7.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20A5Full.tsv", "w") as I:
#     InOut7.to_csv(I,sep = '\t')

# with open( "./InOutPairs/20A6.tsv", "w") as I:
#     InOut8.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20A6Full.tsv", "w") as I:
#     InOut8.to_csv(I,sep = '\t')

# with open( "./InOutPairs/20A7.tsv", "w") as I:
#     InOut9.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20A7Full.tsv", "w") as I:
#     InOut9.to_csv(I,sep = '\t')



# with open( "./InOutPairs/20C8.tsv", "w") as I:
#     InOut12.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20C8Full.tsv", "w") as I:
#     InOut12.to_csv(I,sep = '\t')

# with open( "./InOutPairs/20C9.tsv", "w") as I:
#     InOut13.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20C9Full.tsv", "w") as I:
#     InOut13.to_csv(I,sep = '\t')

# with open( "./InOutPairs/20C11.tsv", "w") as I:
#     InOut15.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20C11Full.tsv", "w") as I:
#     InOut15.to_csv(I,sep = '\t')

# with open( "./InOutPairs/20C10.tsv", "w") as I:
#     InOut14.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20C10Full.tsv", "w") as I:
#     InOut14.to_csv(I,sep = '\t')


# with open( "./InOutPairs/20B12.tsv", "w") as I:
#     InOut23.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20B12Full.tsv", "w") as I:
#     InOut23.to_csv(I,sep = '\t')

# with open( "./InOutPairs/20B13.tsv", "w") as I:
#     InOut24.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20B13Full.tsv", "w") as I:
#     InOut24.to_csv(I,sep = '\t')

# with open( "./InOutPairs/20B14.tsv", "w") as I:
#     InOut25.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20B14Full.tsv", "w") as I:
#     InOut25.to_csv(I,sep = '\t')

# with open( "./InOutPairs/20B15.tsv", "w") as I:
#     InOut26.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20B15Full.tsv", "w") as I:
#     InOut26.to_csv(I,sep = '\t')

# with open( "./InOutPairs/20D16.tsv", "w") as I:
#     InOut27.to_csv(I,sep = '\t', columns=['seq_x', 'seq_y'], header= ['In', 'Out'])

# with open( "./InOutPairs/20D16Full.tsv", "w") as I:
#     InOut27.to_csv(I,sep = '\t')
