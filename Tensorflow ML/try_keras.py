...
vocab_size = 21
embedding_dim = 32 # the vector size which represents the letters
units= 2 # how many ????
seq_length = 67 #or 19
BATCH_SIZE = 3 # Batches of data which will be given to the network at a time (here 10 examples of our sequences)
BUFFER_SIZE = 1273
num_examples = 3
...
Epoch 1/5
1/1 [==============================] - 0s 385ms/step - loss: -0.0053 - accuracy: 0.0775
Epoch 2/5
1/1 [==============================] - 0s 18ms/step - loss: -0.3083 - accuracy: 0.0568
Epoch 3/5
1/1 [==============================] - 0s 13ms/step - loss: -0.4768 - accuracy: 0.0170
Epoch 4/5
1/1 [==============================] - 0s 18ms/step - loss: -0.4470 - accuracy: 0.0063
Epoch 5/5
1/1 [==============================] - 0s 14ms/step - loss: 0.0938 - accuracy: 0.0018
1/1 - 0s - loss: 0.9186 - accuracy: 0.0000e+00 - 101ms/epoch - 101ms/step
"""